...
class FormValidator 
{
  var $validator_array;
  var $error_hash;
  var $custom_error_reported = false; 
  ...
  function add_custom_error($variable, $error)
  {
    $this->error_hash[$variable] = $error;
    $this->custom_error_reported = true;
  }
  ...
  function ValidateForm()
  {
    ...
    return $bret AND !$this->custom_error_reported;
  }
    ...
    return $bret;
  	...
  	function ValidateCommand($command,$command_value,$input_value,&$default_error_message,$variable_name,$formvariables)
  	{
  		...
  		switch($command)
  		{
  			...
  			case 'alnum':
  						{
  							$bret= $this->test_datatype($input_value,"/^[[:alnum:]_]+$/");
  							if(false == $bret)
  							{
  			...
  			case 'alnum_s':
  						{
  							$bret= $this->test_datatype($input_value,"/^[[:alnum:] ]+$/");
  							if(false == $bret)
  							{
              ...
              case 'numeric':
  						{
  							$bret= $this->test_datatype($input_value,"/^[[:digit:]]+$/");
  							if(false == $bret)
  							{
  			...
  			case 'alpha':
  						{
  							$bret= $this->test_datatype($input_value,"/^[[:alpha:]]+$/");
  							if(false == $bret)
  							{
